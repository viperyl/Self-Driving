...
# cd /home/workspace/CarND-Behavioral-Cloning-P3/Model/ && python test.py
# cd /home/workspace/CarND-Behavioral-Cloning-P3/Model/ && python drive.py my_model.h5 run1
...
model.fit_generator(train_generator, samples_per_epoch= 100, validation_data=valid_generator,   nb_val_samples=len(validation_samples), nb_epoch=1, verbose=1)
model.save('model.h5')
